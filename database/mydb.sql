...
-- Add users: 1 Admin and 1 Physician
INSERT INTO Users (username, password, role) VALUES ('adminUser', 'adminPass', 'ADMIN');
INSERT INTO Users (username, password, role) VALUES ('physicianUser', 'physicianPass', 'PHYSICIAN');

-- Retrieve the user_id of the physician for later use
SELECT user_id INTO @physicianID FROM Users WHERE username = 'physicianUser';

-- Add a patient linked to the physician
...
-- Retrieve the patient_id for later use
...
-- Retrieve medication_id for both medications
...
-- Add 5 entries to DailyRecords for the patient
